...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      <title>Student Exam payment Slip</title>
      <style type="text/css">
        table{
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-12 text-center">
      <h5 style="font-weight:bold;padding-top:-25px"> {{$exam_type}}  Fee payment Slip</h5>
  </div>
  <div class="col-md-12">
    @php
    $registrationfee = App\Model\FeeAmount::where('fee_categorie_id','4')->where('class_id',$details->class_id)->first();
    ...
    <div class="row">
      <div class="col-md-12">
        <table width="80%" cellpadding="0" cellspacing="0" padding="0">
          <tr>
            <td width="33%" class="text-center" height="80px"><img src="{{asset('public/backend/dist/img/school-logo.png')}}" alt="img" style="width:100px;height:90px;"> </td>
            <td class="text-center" width="63%" height="80px">
              <h4><strong>School Management</strong></h4>
              <h5><strong>Shibpur, Nabinagar,Brahmanbaria</strong></h5>
              <h6><strong>www.school@gmail.com</strong></h6>
            </td>
      ...
      <div class="col-md-12 text-center">
        <h5 style="font-weight:bold;padding-top:-25px"> {{$exam_type}} payment Slip</h5>
    </div>
    <div class="col-md-12">
      @php
      $registrationfee = App\Model\FeeAmount::where('fee_categorie_id','4')->where('class_id',$details->class_id)->first();
