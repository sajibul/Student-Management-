        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="card">
              ...
              @endif
                <form class="form-horizontal" id="myForm" action="{{(@$editData) ? route('registration-student.update',$editData->student_id) : route('registration-student.store')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  @if(!empty(@$editData))
                  @method('PUT')
                  @endif
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <label for="inputName" class="col-form-label">Student Name <font style="color:red">*</font> </label>
