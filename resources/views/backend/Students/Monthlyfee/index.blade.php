...
@section('content')
@section('tittle','Manage Student Monthly Fee')
@push('css')
<!-- DataTables -->
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                <label for="inputName" class="col-form-label">Month</label>
                <select class="form-control select2 form-control-sm" style="width: 100%;" name="month" id="month">
...
<script>
  $(document).on('click','#search',function(){
    ...
    if(month==''){
      toastr.error("Month required",{className:'error'});
      return false;
    }

    $.ajax({
      url:"{{route('monthly-fee.create')}}",
      type:"get",
