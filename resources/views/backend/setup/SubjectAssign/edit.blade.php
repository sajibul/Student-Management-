                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="alert alert-info btn-btn-danger alert-dismissible fade show" role="alert">
                                ...
                                @endif
                                <form class="form-horizontal" action="{{route('assign-subject.update',$editData[0]->class_id)}}" method="post" enctype="multipart/form-data" id="myForm">
                                    @csrf
                                    @method('PUT')
                                    <div class="add_item">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-2">
                                                ...
                                                <input type="text" name="full_mark[]" class="form-control" id="inputName" value="{{$data->full_mark}}">
                                            ...
                                            <div class="form-group col-sm-2">
                                                ...
                                                <input type="text" name="pass_mark[]" class="form-control" id="inputName" value="{{$data->pass_mark}}">
                                            ...
                                            <div class="form-group col-sm-2">
                                                ...
                                                <input type="text" name="subjective_mark[]" class="form-control" id="inputName" value="{{$data->subjective_mark}}">
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
                                            <button type="submit" class="btn btn-danger text-align-center">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
