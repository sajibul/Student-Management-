          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                  <a class="nav-link active" href="{{route('free-category.create')}}"><i class="fa fa-plus-circle"></i>Add Fee Category</a>
                </li>
              </ul>
            </div>
          </div><!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="edit" href="{{route('free-category.edit',$item->id)}}"> <i class="btn btn-sm btn-primary fas fa-edit" aria-hidden="true"></i></a>
