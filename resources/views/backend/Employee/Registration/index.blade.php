...
@section('content')
@section('tittle','Manage Employee Registration')
@push('css')
<!-- DataTables -->
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                  <a class="nav-link active" href="{{route('employee-registration.create')}}"><i class="fa fa-plus-circle"></i>Add Employee</a>
                </li>
              </ul>
            </div>
          </div><!-- /.card-header -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a title="details" target="_blank" href="{{route('employee-registration.show',$employee->id)}}"><i class="btn btn-sm btn-success fa fa-eye"></i></a>
                      <a title="edit" href="{{route('employee-registration.edit',$employee->id)}}"><i class="btn btn-sm btn-primary fas fa-edit" aria-hidden="true"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
